...
echo "  ide-im setup    — configure IM platform credentials"
echo "  ide-im start    — start the bridge daemon"
echo "  ide-im doctor   — diagnose issues"
